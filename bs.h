...
static void bs_write_u(bs_t* b, uint32_t v, int n);
static void bs_write_f(bs_t* b, uint32_t v, int n);
...
#define bs_skip_bslbf   bs_read_u
#define bs_read_bslbf   bs_read_u
#define bs_read_tcimsbf bs_read_u
#define bs_read_uimsbf  bs_read_u
...
static inline void bs_write_u(bs_t* b, uint32_t v, int n)
{
    int i;
    for (i = 0; i < n; i++)
    {
...
static inline void bs_write_f(bs_t* b, uint32_t v, int n) { bs_write_u(b, v, n); }
